...
import com.team86.mecanum.sensors.CustomADXL345;
import com.team86.mecanum.sensors.Sonar;
...
public class IO {
     ...
     */
    public static CustomDrive1 ROBOT_DRIVE = 
            new CustomDrive1(RIGHT_BACK, RIGHT_FRONT, LEFT_BACK, LEFT_FRONT);
    ...
    public static final Gyro GYRO = new Gyro(GYRO_CHANNEL);
    ...
    public static final AnalogChannel SONAR = new AnalogChannel(SONAR_CHANNEL);
     ...
     */
    public static final CustomADXL345 ACCELEROMETER = new CustomADXL345(1, ADXL345_I2C.DataFormat_Range.k2G);
     ...
     */
    public static final Compressor COMPRESSOR = new Compressor(1, 1);
