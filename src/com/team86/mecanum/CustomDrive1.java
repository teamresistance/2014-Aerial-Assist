 ...
 */
public class CustomDrive1 implements MotorSafety, IUtility {
     ...
     */
    public CustomDrive1(final int leftMotorChannel, final int rightMotorChannel) {
    ...
    /**
     * Constructor for CustomDrive1 with 4 motors specified with channel numbers.
     ...
     */
    public CustomDrive1(final int frontLeftMotor, final int rearLeftMotor,
    ...
    /**
     * Constructor for CustomDrive1 with 2 motors specified as SpeedController objects.
     * The SpeedController version of the constructor enables programs to use the CustomDrive1 classes with
     * subclasses of the SpeedController objects, for example, versions with ramping or reshaping of
     * the curve to suit motor bias or dead-band elimination.
     * @param leftMotor The left SpeedController object used to drive the robot.
     * @param rightMotor the right SpeedController object used to drive the robot.
     */
    public CustomDrive1(SpeedController leftMotor, SpeedController rightMotor) {
    ...
    /**
     * Constructor for CustomDrive1 with 4 motors specified as SpeedController objects.
     * Speed controller input version of CustomDrive1 (see previous comments).
     * @param rearLeftMotor The back left SpeedController object used to drive the robot.
     * @param frontLeftMotor The front left SpeedController object used to drive the robot
     * @param rearRightMotor The back right SpeedController object used to drive the robot.
     * @param frontRightMotor The front right SpeedController object used to drive the robot.
     */
    public CustomDrive1(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
     ...
     */
        public void mecanumDrive_Cartesian(double x, double y, double rotation, double gyroAngle)
        {
            ...
            //System.out.println("Before: X:" + xIn + " Y: " + yIn);
            normalize(wheelSpeeds);
            //System.out.println("After: X:" + xIn + " Y: " + yIn);
            ...
            //System.out.println("Front Left Motor: " + wheelSpeeds[MotorType.kFrontLeft_val] * m_invertedMotors[MotorType.kFrontLeft_val] * m_maxOutput);
            /*System.out.println("Front Left Motor: " + m_frontLeftMotor.get());
            System.out.println("Front Right Motor: " + m_frontRightMotor.get());
            System.out.println("Rear Left Motor: " + m_rearLeftMotor.get());
            System.out.println("Rear Right Motor: " + m_rearRightMotor.get());*/
            
//            System.out.println("Max Output: " + m_maxOutput);
//            System.out.println("Front Left: " + wheelSpeeds[MotorType.kFrontLeft_val] + " " + m_invertedMotors[MotorType.kFrontLeft_val]);
//            System.out.println("Front Right: " + wheelSpeeds[MotorType.kFrontRight_val] + " " + m_invertedMotors[MotorType.kFrontRight_val]);
//            System.out.println("Rear Left: " + wheelSpeeds[MotorType.kRearLeft_val] + " " + m_invertedMotors[MotorType.kRearLeft_val]);
//            System.out.println("Rear Right: " + wheelSpeeds[MotorType.kRearRight_val] + " " + m_invertedMotors[MotorType.kRearRight_val]);
//            
//            System.out.println("Front Right Motor: " + wheelSpeeds[MotorType.kFrontRight_val] * m_invertedMotors[MotorType.kFrontRight_val] * m_maxOutput);
//            System.out.println("Rear Left Motor: " + wheelSpeeds[MotorType.kRearLeft_val] * m_invertedMotors[MotorType.kRearLeft_val] * m_maxOutput);
//            System.out.println("Front Right Motor: " + wheelSpeeds[MotorType.kRearRight_val] * m_invertedMotors[MotorType.kRearRight_val] * m_maxOutput);
