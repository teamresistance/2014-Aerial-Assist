...
import org.teamresistance.mecanum.math.Vector2f;
...
public class Main extends IterativeRobot {
    ...
    public void robotInit() {
         ...
         */
        IO.ROBOT_DRIVE.setInvertedMotor(RobotDrive.MotorType.kFrontRight, true); //true
        IO.ROBOT_DRIVE.setInvertedMotor(RobotDrive.MotorType.kFrontLeft, false); //false
        IO.ROBOT_DRIVE.setInvertedMotor(RobotDrive.MotorType.kRearRight, true);
        IO.ROBOT_DRIVE.setInvertedMotor(RobotDrive.MotorType.kRearLeft, false);
